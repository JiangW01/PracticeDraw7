package demo.wj.practicedraw7.practice.practice06;
    ...
    protected void onAttachedToWindow() {
        ...
        animateBt.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Keyframe keyframe2 = Keyframe.ofFloat(1.0f, 80);
                PropertyValuesHolder propertyValuesHolder = PropertyValuesHolder.ofKeyframe("progress", keyframe, keyframe1, keyframe2);
                ObjectAnimator valueAnimator = ObjectAnimator.ofPropertyValuesHolder(view,propertyValuesHolder);
